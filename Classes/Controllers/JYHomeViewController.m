...
#import "JYLiveRoomViewController.h"
...
- (void)loadView{
    ...
    //直播间
    JYLiveRoomViewController *live = [[JYLiveRoomViewController alloc] init];
    UITabBarItem *firstItem = [[UITabBarItem alloc] initWithTitle:JYLocalizedString(@"home_tab_liveroom_title") image:[UIImage imageNamed:@"btn_home_transparent"] tag:1];
    firstItem.titlePositionAdjustment = UIOffsetMake(-10, -14);
    [firstItem setTitleTextAttributes:@{NSFontAttributeName:JYFont(16)} forState:UIControlStateNormal];
    ...
    UITabBarItem *secondItem = [[UITabBarItem alloc] initWithTitle:JYLocalizedString(@"home_tab_ucenter_title") image:[UIImage imageNamed:@"btn_home_transparent"] tag:2];
    secondItem.titlePositionAdjustment = UIOffsetMake(10, -14);
    [secondItem setTitleTextAttributes:@{NSFontAttributeName:JYFont(16)} forState:UIControlStateNormal];
...
//    self.tabBar.barTintColor = [UIColor whiteColor];
    ...
    [imageView setBackgroundColor:[UIColor jy_primaryColor]];
